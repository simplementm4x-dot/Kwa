...
(function (K) {
  ...
  const RULES = [
    ...
    ['⏱️', 'Tic-Tac', "Un temps a atteindre, entre 4 et 15 secondes. On lance quand on veut, on arrete quand on pense y etre — et il n y a aucun chronometre a l ecran, c est tout le jeu. Dans la meme piece on joue a tour de role, chacun ignorant le resultat des autres. Chacun chez soi, tout le monde joue en meme temps sur le meme temps a atteindre. Le plus proche prend 2 cases, le deuxieme 1, le dernier en perd 1."],
    ['📷', 'Le Cliche', "Une photo arrive completement floue et se resout en six secondes. Quatre reponses, toutes de la meme famille. Repondre pendant le flou complet vaut 4 cases, avant que ce soit net 3, une fois net 2 — et une erreur coute une case quel que soit le moment. Tout le jeu est la : attendre d etre sur, c est jouer pour deux cases. Les photos viennent de Wikimedia Commons."],
    ...
    ['🔀', 'Les cases eclair', "La Caisse et la Roue de Kwa se resolvent en dix secondes, sans mini-jeu. La Roue ne demande aucun talent : entre -3 et +5, et bon courage. La Caisse, elle, ne vous fait pas bouger d une case : elle vous donne un objet."],
    ['📦', 'Les objets', "Une seule poche. Tomber sur une Caisse vous donne un objet au hasard, et vous le sortez avant le de, au tour de votre choix — c est la seule chose du jeu qui se garde. Le Vaisseau vous echange avec un joueur tire au sort. Le De + ajoute 3 cases a votre lance. Le Fantome maudit quelqu un : a son prochain tour, il recule de ce qu il aurait avance. La Roue des couleurs tourne sur vous ou sur qui vous voulez, chaque couleur donnant entre -4 et +4. Le Rocher pousse le joueur de votre choix jusqu au joueur le plus proche derriere lui. Ramasser un second objet oblige a en abandonner un."],
    ...
    ['🏁', 'L epreuve finale', "Arriver au terminus ne suffit pas. Kwa pose une derniere question tiree au hasard, de niveau 8 minimum : les plus dures du paquet. Bonne reponse, la partie est gagnee. Ratee, on recule de 3 cases et la course repart. Quand la question est ouverte, le joueur repond a voix haute et c est la table qui tranche."],
    ['🥇', 'La derniere ligne droite', "Quand le meneur arrive a cinq cases du terminus — ou au dernier tour en mode tours — le plateau vire a l or et tout ce que gagnent les poursuivants compte double. Pas les pertes : on accelere ceux qui reviennent, on ne punit personne. Et pas le meneur, il a deja son avance."],
    ['🌙', 'Les evenements de foret', "De temps en temps la foret change une regle et Kwa l annonce : tout compte double, gagner veut dire reculer, aucun malus ne passe, le meneur paie pour les autres, ou c est Kwa qui choisit votre epreuve. La regle dure trois tours de joueur. Pendant ce temps la pastille en haut a droite compte les tours restants — cliquez dessus pour relire ce qu elle fait et qui elle vise — et le terrain garde la trace de ce qui se passe : des rafales pour le vent, un voile bleu pour la nuit, des pieces qui montent pour la grosse cote."],
    ['👻', 'L esprit de la foret', "Une creature squatte une case du chemin. Elle ne joue a rien : elle attend. Celui qui s arrete sur sa case prend un coup de baton, recule de 3 cases et ne joue PAS l epreuve. Elle rode ensuite vers une autre case, un tour sur deux, et toujours dans vos pattes : elle reste collee au peloton, du dernier joueur a cinq cases devant le premier. Surveillez-la, c est la seule chose du plateau qui bouge sans qu on lance le de."],
    ['🤫', 'Les missions de Kwa', "Dans la meme piece uniquement. Kwa prend un joueur a part et lui donne une consigne a tenir pendant son tour : parler avec l accent belge, glisser le mot aubergine dans une phrase, aller chuchoter une qualite a l oreille de quelqu un. Il accepte ou il refuse, et personne d autre n en sait rien. Kwa revient a son tour suivant : la mission est annoncee a toute la table, le groupe tranche, et si c est passe inapercu ce sont 3 cases. Le joueur ne se note pas lui-meme — des qu il y a plusieurs telephones, le verdict part chez son voisin."],
    ...
    ['🔤', 'Le Mot Raccord', "Une lettre, 30 secondes, une liste de trucs a completer. Chaque mot valide par le groupe = 1 case, et carton plein = 1 case bonus. Des qu il y a plusieurs telephones, ce n est pas le joueur interroge qui coche : le carnet passe a son voisin de tour. Lui parle, l autre valide — on ne se note pas soi-meme, et on ne cherche pas ses mots un doigt sur l ecran."]
  ];
