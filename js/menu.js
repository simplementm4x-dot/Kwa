...
(function (K) {
  ...
  const RULES = [
    ...
    ['👥', 'A deux, c est plus court', "Undercover, Anecdote et Le Dilemme reposent sur un vote a la majorite ou sur un infiltre a demasquer : a deux joueurs ils n ont plus de sens, et Kwa ne les met pas sur le chemin. Le plateau se remplit alors de quiz, de cases eclair et d epreuves en solo. A partir de trois joueurs, tout revient."],
