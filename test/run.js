...
const SUITE = ['content.test.js', 'board.test.js', 'setup.test.js', 'gameplay.test.js', 'libre.test.js', 'esprit.test.js', 'objets.test.js', 'lobby.test.js', 'remote.test.js', 'multi.test.js', 'reconnect.test.js'];
