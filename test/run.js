...
const SUITE = ['content.test.js', 'prompt.test.js', 'board.test.js', 'setup.test.js', 'gameplay.test.js', 'libre.test.js', 'esprit.test.js', 'objets.test.js', 'cliche.test.js', 'scene.test.js', 'course.test.js', 'finale.test.js', 'lobby.test.js', 'remote.test.js', 'multi.test.js', 'reconnect.test.js'];
